...
public class AddIdAdapter  extends RecyclerView.Adapter<AddIdAdapter.MyViewHolder> {

    private ArrayList<Image> images;
    private Context mContext;
    private GetIdImagePosition getIdImagePosition;

    public AddIdAdapter(ArrayList<Image> images, Context mContext, GetIdImagePosition getIdImagePosition) {
        this.images = images;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.img_delete.setOnClickListener(v -> {
            getIdImagePosition.position(position);
        });
    }
