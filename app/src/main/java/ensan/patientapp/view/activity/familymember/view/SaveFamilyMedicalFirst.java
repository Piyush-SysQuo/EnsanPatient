...
public class SaveFamilyMedicalFirst extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener, RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(intent != null){
            ...
            if(bundle != null){
                ...
                id = (Integer) bundle.get(Constants.KEY_FAMILY_MEMBER_ID);
                familyId = String.valueOf(id);
            }
        }
//        token="eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..D4o0_BxIZZTmDRBfUci62ozpBIDGKbIrav3NUirVbXs";
//        id=39;
//        familyId="39";
    ...
    public void nextClick(View view) {
        Intent intent = new Intent(new Intent(this, SaveFamilyMedicalSecond.class));
    ...
    private void checkRunTimePermission() {
        ...
        Dexter.withContext(this).withPermission(Manifest.permission.CAMERA).withListener(new PermissionListener() {
            ...
            public void onPermissionGranted(PermissionGrantedResponse permissionGrantedResponse) {
                selectImage(SaveFamilyMedicalFirst.this);
            }
