...
public class VisitServiceListAdapter extends RecyclerView.Adapter<VisitServiceListAdapter.ViewHolder> {
    ...
    public VisitServiceListAdapter(Context mContext, List<Datum> list, GetCategoryPosition categoryPosition) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.mainLayout.setOnClickListener(v -> {
            ...
            if (isChecked){
                holder.bgLayout.setBackgroundDrawable(mContext.getDrawable(R.drawable.blue_strok_rect));
            }else{
                holder.bgLayout.setBackgroundDrawable(mContext.getDrawable(R.drawable.white_curved));
            }
            categoryPosition.getPosition(position,isChecked);
        });
    }
