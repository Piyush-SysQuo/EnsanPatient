...
public class AddInsuranceAdapter extends RecyclerView.Adapter<AddInsuranceAdapter.MyViewHolder> {

    private ArrayList<Image> images;
    private Context mContext;
    private GetInsDocPosition getIdImagePosition;

    public AddInsuranceAdapter(ArrayList<Image> images, Context mContext, GetInsDocPosition getIdImagePosition) {
        this.images = images;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.img_delete.setOnClickListener(v -> {
            getIdImagePosition.getPosition(position);
        });
    }
