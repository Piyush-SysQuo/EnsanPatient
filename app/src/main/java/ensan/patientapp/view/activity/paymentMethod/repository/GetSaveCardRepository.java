...
public class GetSaveCardRepository {

    private MutableLiveData<GetSaveCard> mutableLiveData;


    public GetSaveCardRepository() {
    ...
    public void getSaveCard(@NonNull String token){
        ...
        Call<GetSaveCard> call = apiDataService.getSaveCard("application/json","Bearer "+token);
    ...
    public LiveData<GetSaveCard> getSaveCardLiveData() {
